...
name = gets.chomp 
puts "HOWDY #{name.upcase}!!!!! DOTMC here! I am an interactive 'Days of the Month' calculator.Excluding leap years, enter any month (1-12) below, and I will give you the answer! What is the month you would like to know?"
